...
class ModelTrainer:
    ...
    def train_model(self,x,y):
        try:
            rf =  RandomForestClassifier(max_depth=40, n_estimators=102, random_state=30)
            rf.fit(x,y)
            return rf
        except Exception as e:
            raise SensorException(e, sys)
    ...
    def initiate_model_trainer(self,)->artifact_entity.ModelTrainerArtifact:
        try:
            ...
            # overfiting --> train = good and test = bad
            # underfitting --> train = bad and test = bad
            # expected --> train = good and test = good
